...
export default function StudentDashboard({ setActiveTab, initialSection = 'jobs' }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-3 bg-white/95 backdrop-blur-xs p-2 sm:p-2.5 rounded-2xl border border-slate-200/90 shadow-2xs">
        <div className="relative max-w-full overflow-hidden w-full xl:w-auto">
          <div className="flex items-center gap-1 p-1 bg-slate-100/80 rounded-xl overflow-x-auto no-scrollbar scroll-smooth">
            ...
            <button
              ...
              className={`group flex items-center gap-2 px-3.5 py-2 rounded-lg text-xs font-semibold transition-all duration-200 shrink-0 cursor-pointer select-none ${
